...
class Bootstrap_Comment_Walker extends Walker_Comment {
	...
	protected function html5_comment( $comment, $depth, $args ) {
		...
		?>
        <<?php echo wp_kses_post( $tag ); ?> id="comment-<?php comment_ID(); ?>" <?php comment_class( $this->has_children ? 'has-children media' : ' media' ); ?>>
    ...
    <div class="media-body card mt-3 " id="div-comment-<?php comment_ID(); ?>">
        <div class="card-header hoverable">
            ...
            <div class="comment-metadata flex-center">
                ...
                <ul class="list-inline">
					<?php edit_comment_link( __( 'Edit', 'philosophy' ), '<li class="edit-link list-inline-item btn btn-secondary chip">', '</li>' ); ?>
					<?php
		...
		<?php if ( '0' == $comment->comment_approved ) : ?>
            <p class="card-text comment-awaiting-moderation label label-info text-muted small"><?php _e( 'Your comment is awaiting moderation.', 'philosophy' ); ?></p>
		<?php endif; ?>
